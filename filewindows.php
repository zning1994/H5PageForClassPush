    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li><a href="./">首页</a></li>
                <li class="active"><a href="./windows.html">Windows程序设计电子版报告与源码提交</a></li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">更多<span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="http://www.smcm.cc">返回SMCMCC</a></li>
                        <li><a href="http://www.zning.net.cn" target="_blank">返回张宁网</a></li>
                        <li role="separator" class="divider"></li>
                        <li class="dropdown-header">更多网站</li>
                        <li><a href="http://www.sdust.edu.cn" target="_blank">山东科技大学</a></li>
                        <li><a href="http://www.google.com/ncr" target="_blank">Google</a></li>
                    </ul>
                </li>
            </ul>
        </div><!--/.nav-collapse -->
...
<div class="container theme-showcase" role="main">
    ...
    <div class="alert alert-info" role="alert">
        ...
        <div class="alert alert-danger" role="alert">
            <strong>注意: </strong> 提交的<b> 截止日期为:2016年05月31日14时整 </b>,请注意时间安排. 如有错误提交请于<b> 2015年11月11日下午18点前 </b>联系网站管理员。联系方式：<a href="tel:+8613687671402">136-8767-1402</a>(手机浏览网页，点击电话可拨打)
        </div>
